...
- Current status: AMS v1 accepted; AMS V2 Phase 2 error/success attribution complete for seeded outcomes and guarded runtime traces; Phase 3 is next.
- Current next gap: implement V2 Phase 3 - Invariants, skills, and authority scope.
