...
Current V2 build status: Phase 6 reasoning controller and under-the-hood UX is
complete; Phase 7 supersession and active forgetting is the next active rail.
